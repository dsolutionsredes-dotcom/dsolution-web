  ...
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#F7F3EA_0%,#FFFFFF_100%)] px-5 py-20 md:px-8">
      <div className="mx-auto max-w-4xl rounded-[2rem] border border-slate-200 bg-white p-8 shadow-[0_18px_40px_rgba(0,33,71,.08)] md:p-12">
        ...
        <h1 className="mt-5 text-4xl font-semibold text-[#002147]">Automatización e IA</h1>
        <p className="mt-5 text-lg leading-8 text-slate-600">Página de servicio en preparación. En la siguiente fase podremos desarrollar esta página con automatizaciones, agentes y casos de uso.</p>
