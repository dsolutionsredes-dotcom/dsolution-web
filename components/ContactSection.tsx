...
export default function ContactSection({ locale, contact = {}, source = 'd-solution.org', visualEditingEnabled = false }: { locale: Locale; contact?: Contact; source?: string; visualEditingEnabled?: boolean }) {
  ...
  return <section id="contacto" className="px-5 pb-20 md:px-8"><div className="mx-auto grid max-w-6xl gap-8 rounded-[2rem] bg-[#002147] p-7 text-white shadow-[0_30px_70px_rgba(0,33,71,.22)] md:grid-cols-[.85fr_1.15fr] md:p-10">
    <div><p className="section-eyebrow">{copy.eyebrow}</p><h2 className="section-title mt-3 text-white">{copy.title}</h2><span className="section-divider" aria-hidden="true" />
